...
namespace application {
    namespace game {
        ...
        GameSession::GameSession(const Map& map, bool is_random_spawn) : map_(std::make_shared<Map>(map)), is_random_spawn_(is_random_spawn) {
        ...
        std::pair<PlayerToken, size_t> GameSession::AddPlayer(std::string& name) {
            ...
            Coordinates coordinates = map_->GetRandomPosition(is_random_spawn_);
        ...
        std::pair<PlayerToken, size_t> Game::AddPlayer(const Map* map, std::string& name) {
            ...
            if (it == sessions_.end()) {
                GameSession new_session(*map, is_random_spawn_);
