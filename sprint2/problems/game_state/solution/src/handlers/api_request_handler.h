...
namespace http_handler {
    namespace api_handler {
        ...
        private:
            ...
            std::vector<const Player*> GetPlayersDefaultHandler() {
                ...
                const auto* player = application_.GetPlayer(token);
            ...
            void HandleGetPlayers() {
                std::vector<const Player*> players = GetPlayersDefaultHandler();
