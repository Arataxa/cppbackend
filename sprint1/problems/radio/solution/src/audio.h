...
public:
    Recorder(ma_format format, int channels) : frame_size_(0), init_result_(MA_SUCCESS), current_off_(0) {
...
public:
    Player(ma_format format, int channels) : frame_size_(0), init_result_(MA_SUCCESS), current_buffer_(nullptr), current_off_(0), max_frame_(0) {
        ma_device_config device_config;
