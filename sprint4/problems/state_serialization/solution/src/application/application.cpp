...
Application::Application(Game&& game, loot_type_info::LootTypeInfo&& type_info, const std::string& state_file) 
	: game_(std::move(game)), loot_type_info_(std::move(type_info)), state_file_(state_file) {
}
