...
namespace application {
    namespace serialization {
        ...
        GameSession GameSessionSerialization::ToGameSession(const Map& map, bool is_random_spawn, loot_gen::LootGenerator loot_generator, double retirement_time) {
            loot_generator.SetTimeWithoutLoot(time_without_loot_);
            GameSession game_session(map, is_random_spawn, loot_generator, retirement_time);
